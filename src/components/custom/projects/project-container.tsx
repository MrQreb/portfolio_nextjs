    ...
    return (
        <>
            ...
            <div className="mt-8 w-[90%] md:w-[80%] h-[550px] md:h-[400px] rounded-xl bg-[#252424] m-auto grid grid-rows-[50%_30%_20%]
                ...
                <div className="bg-[#3D3C3C] w-[85%] m-auto rounded-2xl h-[60px] md:h-[75px] flex justify-center gap-4 md:row-start-3 md:col-start-2 mt-4">
                ...
                {hasRepository && <Link href={repositoryLink}> <Github className="absolute bottom-1 right-1 md:bottom-3 md:right-3 size-7 md:size-13 cursor-pointer hover:scale-115 transition-all" /> </Link>}
            </div>
        </>
    );
};
